    ...
    <div className="max-w-screen-lg mx-auto px-4 py-16">
      ...
      >
        <div className="flex flex-col items-center mb-12 text-center">
          ...
          <div>
            <H2 className="!text-3xl md:!text-4xl !font-bold !m-0 bg-clip-text text-transparent bg-gradient-to-r from-zinc-800 to-zinc-500 dark:from-zinc-100 dark:to-zinc-400">
        ...
        <div
          className="
          prose prose-lg sm:prose-xl dark:prose-invert max-w-none leading-relaxed
