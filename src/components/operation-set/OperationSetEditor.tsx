        ...
        <div className="grow basis-full lg:overflow-y-auto">
          <FormField
            ...
            ControllerProps={{
              ...
              render: (renderProps) => (
                <InputGroup {...renderProps.field} value={renderProps.field.value || ""} />
              ),
            }}
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <Checkbox
                ...
                onChange={(e) =>
                  field.onChange((e.target as HTMLInputElement).checked ? "PUBLIC" : "PRIVATE")
                }
                label={t.components.operationSet.OperationSetEditor.visible_to_all}
              />
            )}
          />
        </div>
      ...
      <div className="mb-2 flex">
        ...
        >
          <Button
            ...
            minimal
            icon="sort"
            text={t.components.operationSet.OperationSetEditor.quick_sort + "..."}
          />
        </Popover2>
        <Button
          small
