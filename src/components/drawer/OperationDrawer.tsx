...
export function OperationDrawer() {
  ...
  if (operationSetId) {
    return (
      <Drawer size={DrawerSize.LARGE} isOpen={!!operationSetId} onClose={closeOperationSet}>
        {operationSetId && (
          <OperationSetViewer operationSetId={operationSetId} onCloseDrawer={closeOperationSet} />
        )}
        ...
        >
          {operationId && (
            <OperationViewer operationId={operationId} onCloseDrawer={closeOperation} />
          )}
        </Drawer>
      </Drawer>
    );
